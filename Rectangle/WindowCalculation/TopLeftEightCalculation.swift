...
class TopLeftEightCalculation: WindowCalculation, OrientationAware, EightsRepeated {
    ...
    func landscapeRect(_ visibleFrameOfScreen: CGRect) -> RectResult {
        ...
        return RectResult(rect, subAction: .topLeftEight)
    }
