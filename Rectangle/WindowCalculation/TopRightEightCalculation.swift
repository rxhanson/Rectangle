//
//  TopRightEightCalculation.swift
//  Rectangle
//
...
class TopRightEightCalculation: WindowCalculation, OrientationAware, EightsRepeated {
    ...
    func landscapeRect(_ visibleFrameOfScreen: CGRect) -> RectResult {
        ...
        return RectResult(rect, subAction: .topRightEight)
    }
