...
class Defaults {
    ...
    static let marginTop = FloatDefault(key: "marginTop", defaultValue: 5)
    static let marginBottom = FloatDefault(key: "marginBottom", defaultValue: 5)
    static let marginLeft = FloatDefault(key: "marginLeft", defaultValue: 5)
    static let marginRight = FloatDefault(key: "marginRight", defaultValue: 5)
