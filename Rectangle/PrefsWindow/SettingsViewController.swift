...
class SettingsViewController: NSViewController {
    ...
    @IBAction func showExtraSettings(_ sender: NSButton) {
        if extraSettingsPopover == nil {
            ...
            let twelfthsLabel = NSTextField(labelWithString: NSLocalizedString("Twelfths (4\u{00d7}3)", tableName: "Main", value: "", comment: ""))
            twelfthsLabel.alignment = .right
            twelfthsLabel.translatesAutoresizingMaskIntoConstraints = false

            let sixteenthsLabel = NSTextField(labelWithString: NSLocalizedString("Sixteenths (4\u{00d7}4)", tableName: "Main", value: "", comment: ""))
